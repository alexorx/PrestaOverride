...
class PackCore extends Product
{
	...
	public static function getItemTable($id_product, $id_lang, $full = false)
	{
		...
		*/
		// Modificato per aggiungere il nome del produttore disponibili nella
		// lista dei prodotti all'interno di un pack.
		// e-terna AS 17/03/2014
		foreach ($result as &$line) {
			$line = Product::getTaxesInformations($line);
			$line['manufacturer_name']= Manufacturer::getNameById((int)$line['id_manufacturer']);
		}
